# P06-003: permanent displayed-address regression (7.14.2)

Pin host c9182c9b6ed11f0d5db054b81d3da2e65b245536, fork PR
https://github.com/BitHighlander/python-keepkey/pull/78, above firmware
71617e991 (response lifetime fix).

The existing screenshot-selected Ripple address test now checks the known
returned address for 7.14.2 and later. All three address host tests pass with
