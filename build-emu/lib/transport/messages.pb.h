...
/* Generated by nanopb-0.3.9.4 at Tue Mar 24 17:12:55 2026. */
...
typedef enum _MessageType {
    ...
    MessageType_MessageType_ChangeWipeCode = 111,
    MessageType_MessageType_EthereumSignTypedHash = 112,
    MessageType_MessageType_EthereumTypedDataSignature = 113,
    MessageType_MessageType_Ethereum712TypesValues = 114,
    MessageType_MessageType_EthereumTxMetadata = 115,
    MessageType_MessageType_EthereumMetadataAck = 116,
    MessageType_MessageType_GetBip85Mnemonic = 120,
    MessageType_MessageType_Bip85Mnemonic = 121,
    ...
    MessageType_MessageType_ThorchainGetAddress = 500,
    MessageType_MessageType_ThorchainAddress = 501,
    MessageType_MessageType_ThorchainSignTx = 502,
    MessageType_MessageType_ThorchainMsgRequest = 503,
    MessageType_MessageType_ThorchainMsgAck = 504,
    MessageType_MessageType_ThorchainSignedTx = 505,
    ...
    MessageType_MessageType_NanoGetAddress = 700,
    MessageType_MessageType_NanoAddress = 701,
    MessageType_MessageType_NanoSignTx = 702,
    MessageType_MessageType_NanoSignedTx = 703,
    MessageType_MessageType_SolanaGetAddress = 750,
    MessageType_MessageType_SolanaAddress = 751,
    MessageType_MessageType_SolanaSignTx = 752,
    MessageType_MessageType_SolanaSignedTx = 753,
    MessageType_MessageType_SolanaSignMessage = 754,
    MessageType_MessageType_SolanaMessageSignature = 755,
    MessageType_MessageType_BinanceGetAddress = 800,
    MessageType_MessageType_BinanceAddress = 801,
    MessageType_MessageType_BinanceGetPublicKey = 802,
    MessageType_MessageType_BinancePublicKey = 803,
    MessageType_MessageType_BinanceSignTx = 804,
    MessageType_MessageType_BinanceTxRequest = 805,
    MessageType_MessageType_BinanceTransferMsg = 806,
    MessageType_MessageType_BinanceOrderMsg = 807,
    MessageType_MessageType_BinanceCancelMsg = 808,
    MessageType_MessageType_BinanceSignedTx = 809,
    MessageType_MessageType_CosmosGetAddress = 900,
    MessageType_MessageType_CosmosAddress = 901,
    MessageType_MessageType_CosmosSignTx = 902,
    MessageType_MessageType_CosmosMsgRequest = 903,
    MessageType_MessageType_CosmosMsgAck = 904,
    MessageType_MessageType_CosmosSignedTx = 905,
    MessageType_MessageType_CosmosMsgDelegate = 906,
    MessageType_MessageType_CosmosMsgUndelegate = 907,
    MessageType_MessageType_CosmosMsgRedelegate = 908,
    MessageType_MessageType_CosmosMsgRewards = 909,
    MessageType_MessageType_CosmosMsgIBCTransfer = 910,
    MessageType_MessageType_TendermintGetAddress = 1000,
    MessageType_MessageType_TendermintAddress = 1001,
    MessageType_MessageType_TendermintSignTx = 1002,
    MessageType_MessageType_TendermintMsgRequest = 1003,
    MessageType_MessageType_TendermintMsgAck = 1004,
    MessageType_MessageType_TendermintMsgSend = 1005,
    MessageType_MessageType_TendermintSignedTx = 1006,
    MessageType_MessageType_TendermintMsgDelegate = 1007,
    MessageType_MessageType_TendermintMsgUndelegate = 1008,
    MessageType_MessageType_TendermintMsgRedelegate = 1009,
    MessageType_MessageType_TendermintMsgRewards = 1010,
    MessageType_MessageType_TendermintMsgIBCTransfer = 1011,
    MessageType_MessageType_OsmosisGetAddress = 1100,
    MessageType_MessageType_OsmosisAddress = 1101,
    MessageType_MessageType_OsmosisSignTx = 1102,
    MessageType_MessageType_OsmosisMsgRequest = 1103,
    MessageType_MessageType_OsmosisMsgAck = 1104,
    MessageType_MessageType_OsmosisMsgSend = 1105,
    MessageType_MessageType_OsmosisMsgDelegate = 1106,
    MessageType_MessageType_OsmosisMsgUndelegate = 1107,
    MessageType_MessageType_OsmosisMsgRedelegate = 1108,
    MessageType_MessageType_OsmosisMsgRewards = 1109,
    MessageType_MessageType_OsmosisMsgLPAdd = 1110,
    MessageType_MessageType_OsmosisMsgLPRemove = 1111,
    MessageType_MessageType_OsmosisMsgLPStake = 1112,
    MessageType_MessageType_OsmosisMsgLPUnstake = 1113,
    MessageType_MessageType_OsmosisMsgIBCTransfer = 1114,
    MessageType_MessageType_OsmosisMsgSwap = 1115,
    MessageType_MessageType_OsmosisSignedTx = 1116,
    MessageType_MessageType_MayachainGetAddress = 1200,
    MessageType_MessageType_MayachainAddress = 1201,
    MessageType_MessageType_MayachainSignTx = 1202,
    MessageType_MessageType_MayachainMsgRequest = 1203,
    MessageType_MessageType_MayachainMsgAck = 1204,
    MessageType_MessageType_MayachainSignedTx = 1205,
    MessageType_MessageType_ZcashSignPCZT = 1300,
    MessageType_MessageType_ZcashPCZTAction = 1301,
    MessageType_MessageType_ZcashPCZTActionAck = 1302,
    MessageType_MessageType_ZcashSignedPCZT = 1303,
    MessageType_MessageType_ZcashGetOrchardFVK = 1304,
    MessageType_MessageType_ZcashOrchardFVK = 1305,
    MessageType_MessageType_ZcashTransparentInput = 1306,
    MessageType_MessageType_ZcashTransparentSig = 1307,
    MessageType_MessageType_TronGetAddress = 1400,
    MessageType_MessageType_TronAddress = 1401,
    MessageType_MessageType_TronSignTx = 1402,
    MessageType_MessageType_TronSignedTx = 1403,
    MessageType_MessageType_TonGetAddress = 1500,
    MessageType_MessageType_TonAddress = 1501,
    MessageType_MessageType_TonSignTx = 1502,
    MessageType_MessageType_TonSignedTx = 1503
} MessageType;
#define _MessageType_MIN MessageType_MessageType_Initialize
#define _MessageType_MAX MessageType_MessageType_TonSignedTx
#define _MessageType_ARRAYSIZE ((MessageType)(MessageType_MessageType_TonSignedTx+1))
...
typedef struct _Bip85Mnemonic {
    char mnemonic[241];
/* @@protoc_insertion_point(struct:Bip85Mnemonic) */
} Bip85Mnemonic;
...
typedef struct _ChangeWipeCode {
    bool has_remove;
    bool remove;
/* @@protoc_insertion_point(struct:ChangeWipeCode) */
} ChangeWipeCode;
...
typedef PB_BYTES_ARRAY_T(2048) DebugLinkState_layout_t;
...
typedef struct _GetBip85Mnemonic {
    uint32_t word_count;
    uint32_t index;
/* @@protoc_insertion_point(struct:GetBip85Mnemonic) */
} GetBip85Mnemonic;
...
#define Features_init_default                    {false, "", false, 0, false, 0, false, 0, false, 0, false, "", false, 0, false, 0, false, "", false, "", 0, {}, false, 0, false, {0, {0}}, false, {0, {0}}, false, 0, false, 0, false, 0, 0, {PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default}, false, "", false, "", false, {0, {0}}, false, 0, false, 0, false, 0}
...
#define Ping_init_default                        {false, "", false, 0, false, 0, false, 0, false, 0}
...
#define GetBip85Mnemonic_init_default            {0, 0}
#define Bip85Mnemonic_init_default               {""}
...
#define ApplyPolicies_init_default               {0, {PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default, PolicyType_init_default}}
...
#define Features_init_zero                       {false, "", false, 0, false, 0, false, 0, false, 0, false, "", false, 0, false, 0, false, "", false, "", 0, {}, false, 0, false, {0, {0}}, false, {0, {0}}, false, 0, false, 0, false, 0, 0, {PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero}, false, "", false, "", false, {0, {0}}, false, 0, false, 0, false, 0}
...
#define Ping_init_zero                           {false, "", false, 0, false, 0, false, 0, false, 0}
...
#define GetBip85Mnemonic_init_zero               {0, 0}
#define Bip85Mnemonic_init_zero                  {""}
...
#define ApplyPolicies_init_zero                  {0, {PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero, PolicyType_init_zero}}
...
#define Bip85Mnemonic_mnemonic_tag               1
...
#define Features_wipe_code_protection_tag        25
#define Features_auto_lock_delay_ms_tag          26
...
#define GetBip85Mnemonic_word_count_tag          1
#define GetBip85Mnemonic_index_tag               2
...
#define Ping_wipe_code_protection_tag            5
...
#define ResetDevice_u2f_counter_tag              9
...
extern const pb_field_t Features_fields[25];
...
extern const pb_field_t Ping_fields[6];
...
extern const pb_field_t GetBip85Mnemonic_fields[3];
extern const pb_field_t Bip85Mnemonic_fields[2];
...
extern const pb_field_t ChangeWipeCode_fields[2];

/* Maximum encoded size of messages (where known) */
#define Initialize_size                          0
#define GetFeatures_size                         0
#define Features_size                            (387 + 0*CoinType_size + 6*PolicyType_size)
...
#define GetBip85Mnemonic_size                    12
#define Bip85Mnemonic_size                       244
...
#define ApplyPolicies_size                       (36 + 6*PolicyType_size)
...
#define DebugLinkState_size                      (2725 + HDNodeType_size)
