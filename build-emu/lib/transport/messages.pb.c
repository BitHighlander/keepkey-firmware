...
const pb_field_t Features_fields[25] = {
    ...
    PB_FIELD( 25, BOOL    , OPTIONAL, STATIC  , OTHER, Features, wipe_code_protection, no_backup, 0),
    PB_FIELD( 26, UINT32  , OPTIONAL, STATIC  , OTHER, Features, auto_lock_delay_ms, wipe_code_protection, 0),
    PB_LAST_FIELD
};
...
const pb_field_t Ping_fields[6] = {
    ...
    PB_FIELD(  5, BOOL    , OPTIONAL, STATIC  , OTHER, Ping, wipe_code_protection, passphrase_protection, 0),
    PB_LAST_FIELD
};
...
const pb_field_t ResetDevice_fields[10] = {
    ...
    PB_FIELD(  9, UINT32  , OPTIONAL, STATIC  , OTHER, ResetDevice, u2f_counter, auto_lock_delay_ms, 0),
    PB_LAST_FIELD
};
...
const pb_field_t GetBip85Mnemonic_fields[3] = {
    PB_FIELD(  1, UINT32  , REQUIRED, STATIC  , FIRST, GetBip85Mnemonic, word_count, word_count, 0),
    PB_FIELD(  2, UINT32  , REQUIRED, STATIC  , OTHER, GetBip85Mnemonic, index, word_count, 0),
    PB_LAST_FIELD
};

const pb_field_t Bip85Mnemonic_fields[2] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, Bip85Mnemonic, mnemonic, mnemonic, 0),
    PB_LAST_FIELD
};
...
const pb_field_t SignTx_fields[10] = {
    ...
    PB_FIELD( 10, UINT32  , OPTIONAL, STATIC  , OTHER, SignTx, branch_id, version_group_id, 0),
    PB_LAST_FIELD
};
...
const pb_field_t ChangeWipeCode_fields[2] = {
    PB_FIELD(  1, BOOL    , OPTIONAL, STATIC  , FIRST, ChangeWipeCode, remove, remove, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(Features, policies[0]) < 65536 && pb_membersize(CoinTable, table[0]) < 65536 && pb_membersize(Entropy, entropy) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SignMessage, message) < 65536 && pb_membersize(VerifyMessage, message) < 65536 && pb_membersize(EncryptMessage, message) < 65536 && pb_membersize(EncryptedMessage, message) < 65536 && pb_membersize(DecryptMessage, message) < 65536 && pb_membersize(DecryptedMessage, message) < 65536 && pb_membersize(CipherKeyValue, value) < 65536 && pb_membersize(CipheredKeyValue, value) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(RawTxAck, tx) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(SignIdentity, challenge_hidden) < 65536 && pb_membersize(ApplyPolicies, policy[0]) < 65536 && pb_membersize(FlashWrite, data) < 65536 && pb_membersize(DebugLinkFlashDumpResponse, data) < 65536 && pb_membersize(DebugLinkState, layout) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_GetCoinTable_CoinTable_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_GetBip85Mnemonic_Bip85Mnemonic_SignTx_TxRequest_TxAck_RawTxAck_SignIdentity_SignedIdentity_ApplyPolicies_FlashHash_FlashWrite_FlashHashResponse_DebugLinkFlashDump_DebugLinkFlashDumpResponse_SoftReset_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkFillConfig_ChangeWipeCode)
#endif

#if !defined(PB_FIELD_16BIT) && !defined(PB_FIELD_32BIT)
#error Field descriptor for DebugLinkState.layout is too large. Define PB_FIELD_16BIT to fix this.
#endif
