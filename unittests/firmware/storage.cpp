...
void storage_writeStorageV20(char *, size_t, const Storage *);
...
void storage_readStorageV20(Storage *, const char *, size_t);
}
...
TEST(Storage, VersionedWritersRejectShortBuffersWithoutWriting) {
  ...
  check(storage_writeStorageV19, 1501 + sizeof(storage.encrypted_sec));
  check(storage_writeStorageV20, 1501 + sizeof(storage.encrypted_sec));
}
...
TEST(Storage, VersionedReadersRejectShortBuffersWithoutChangingState) {
  ...
  check(storage_readStorageV20, 1501 + sizeof(storage.encrypted_sec));
}
