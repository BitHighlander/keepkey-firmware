...
TEST(ContactBook, ParsesBulkRequestAndMatchesHostRoot) {
  const auto request =
      hex("4b4b414252455131010000000703"
          "00000001111111111111111111111111111111111111111105416c696365"
          "00000089222222222222222222222222222222222222222203426f62"
          "000000013333333333333333333333333333333333333333054361726f6c");
  const auto expected_root =
      hex("046f5dccc5f7cbd27fcf16f28ea93897a3d487bc5a24591fb721b2e8d17459f9");
...
TEST(ContactBook, RejectsControlCharactersAndTrailingData) {
  auto request =
      hex("4b4b414252455131010000000101"
          "00000001111111111111111111111111111111111111111103426f62");
  ContactBookManifest manifest{};
  ContactBookEntry entries[CONTACT_BOOK_MAX_ENTRIES]{};
  request.back() = '\n';
