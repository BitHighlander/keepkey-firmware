...
const pb_field_t CoinType_fields[22] = {
    ...
    PB_FIELD( 16, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, xpub_magic, contract_address, &CoinType_xpub_magic_default),
    PB_FIELD( 18, BOOL    , OPTIONAL, STATIC  , OTHER, CoinType, segwit, xpub_magic, 0),
    ...
    PB_FIELD( 25, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, xpub_magic_segwit_p2sh, decred, 0),
    PB_FIELD( 26, UINT32  , OPTIONAL, STATIC  , OTHER, CoinType, xpub_magic_segwit_native, xpub_magic_segwit_p2sh, 0),
    PB_FIELD( 27, STRING  , OPTIONAL, STATIC  , OTHER, CoinType, nanoaddr_prefix, xpub_magic_segwit_native, 0),
    PB_FIELD( 28, BOOL    , OPTIONAL, STATIC  , OTHER, CoinType, taproot, nanoaddr_prefix, 0),
    PB_LAST_FIELD
};
...
const pb_field_t TxOutputType_fields[9] = {
    ...
    PB_FIELD(  9, UINT32  , OPTIONAL, STATIC  , OTHER, TxOutputType, decred_script_version, address_type, 0),
    PB_LAST_FIELD
};
...
const pb_field_t TransactionType_fields[14] = {
    ...
    PB_FIELD( 13, UINT32  , OPTIONAL, STATIC  , OTHER, TransactionType, branch_id, version_group_id, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, script_sig) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TxOutputBinType, script_pubkey) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536 && pb_membersize(TransactionType, extra_data) < 65536 && pb_membersize(TxRequestSerializedType, serialized_tx) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_TxOutputType_TxOutputBinType_TransactionType_RawTransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType_PolicyType)
#endif
